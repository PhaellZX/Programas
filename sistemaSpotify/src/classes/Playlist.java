...
public class Playlist {
	...
	public void addMusica(Musica m) {  // ok
	...
	public void removerMusica(Musica m) {  // ok
		
		this.musica.remove(m);
		
	}
	
	public void alterarPosicao(Musica m, int novaPosicao) {  // RESOLVER
	...
	public void getTotalMusicas() { // ok
		
		System.out.println("♪ Qtd de músicas: " + this.musica.size());
		
	}
	
	public void getDuracao(int seg) {  // ok
